            ...
            <div class="login-wrapper shadow bg-body rounded">
                ...
                <div class="tab-content" id="accountTabContent">
                    ...
                    <div class="tab-pane fade body-login-wrapper" id="pills-register" role="tabpanel"
                        ...
                        <input type="text" class="form-control mb-3" placeholder="Nhập Họ" aria-label="Username">
                        <h6>TÊN <span class="text-danger">*</span></h6>
                        <input type="text" class="form-control mb-3" placeholder="Nhập Tên" aria-label="Username">
                        <h6>SỐ ĐIỆN THOẠI <span class="text-danger">*</span></h6>
                        <input type="text" class="form-control mb-3" placeholder="Nhập Số điện thoại" aria-label="Username">
                        <h6>EMAIL <span class="text-danger">*</span></h6>
