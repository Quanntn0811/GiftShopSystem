                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between align-items-center lh-sm">
                                    <div class="d-flex align-items-center gap-4">
                                        <img src="https://bizweb.dktcdn.net/thumb/compact/100/450/808/products/cfa1d6c5-ffa0-4fcd-8349-51e83792254e.jpg"
                                             class=""
                                             style="width: 50px; height: 50px; object-fit: cover; border-radius: 8px;" />
                                        <h6 class="my-0">Bé lừa bông Winnie</h6>
                                    </div>
                                    <span class="text-muted">390000 đ</span>
                                </li>
                        ...
                        <div class="col-md-7 col-lg-8 row g-5 mt-0">
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        <label for="country" class="form-label">Tỉnh thành</label>
                                    ...
                                    <div class="col-12">
                                        <label for="state" class="form-label">Quận huyện (tùy chọn)</label>
